...
def main():
    ...
    parser.add_option("-D", "--check-database", help="like NT_CN_17Q3,Unidb_NT_CN_17Q3,HERE_KOR17Q3",
                      dest="check_database")
    ...
    return check_tablespace(input_options.check_host, input_options.check_database, input_options.check_tablespace, input_options.default_size)
