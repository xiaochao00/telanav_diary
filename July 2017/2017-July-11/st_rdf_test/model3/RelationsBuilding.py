...
class RelationsBuilding(Record):
    ...
    def dump2file(self):
        ...
        print cmd
        self.cursor.copy_expert("COPY (%s) TO STDOUT DELIMITER '`' CSV "%(cmd),open(self.building_dump_file,"w"))
    ...
    def dumpenbuilding2file(self):
        ...
        print cmd
        self.cursor.copy_expert("COPY (%s) TO STDOUT DELIMITER '`' CSV "%(cmd),open(self.enbuilding_dump_file,"w"))
